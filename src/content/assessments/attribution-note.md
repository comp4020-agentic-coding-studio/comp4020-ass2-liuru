...
marking:
  ...
  criteria:
    ...
    - name: Argument structure
      weight: 35
    - name: Awareness of counter-evidence
      weight: 25
spec:
...
and not merely obscure. State your claim plainly in the first paragraph ---
"this painting is/is not by Tang Yin, on the following grounds" --- rather
than building to a reveal. The room for judgement is in how you weigh
materials against brushwork when they don't perfectly agree, which they
usually don't; the mechanics are in naming your evidence precisely enough
...
course system. Cite every reproduction and source you used, including any
